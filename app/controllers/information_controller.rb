class InformationController < ApplicationController
  ...
  def create
    @information = Information.find_or_initialize_by(user_id: current_user.id)
  ...
  def update
    respond_to do |format|
      if @information.update(information_params)
        format.html { redirect_to new_job_path, notice: "Information was successfully updated." }
  ...
  private
    ...
    def information_params
      params.require(:information).permit(:name, :department, :user_id, positions_attributes: [:id, :position, :position_date, :_destroy])
    end
end
